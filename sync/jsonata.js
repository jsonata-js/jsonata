...
var jsonata = (function() {
    ...
    /* async */ function evaluateUnary(expr, input, environment) {
        ...
        switch (expr.value) {
            ...
            case '[':
                ...
                result = [];
                let generators = /* await */ Array.from(expr.expressions
                    .map(/* async */ (item, idx) => {
    ...
    /* async */ function evaluateGroupExpression(expr, input, environment) {
        ...
        let generators = /* await */ Array.from(Object.keys(groups).map(/* async */ (key, idx) => {
    ...
    /* async */ function applyInner(proc, args, input, environment) {
        ...
        try {
            ...
            if (isLambda(proc)) {
                ...
                if (isPromise(result)) throw new Error("Check \"if (isPromise(result))\" evaluated to a promise");
