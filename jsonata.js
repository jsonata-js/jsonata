...
var jsonata = (function() {
    ...
    function* evaluateGroupExpression(expr, input, environment) {
        ...
        // if a multiple key expressions evaluate to the same key, then error D1009 must be thrown
        // create a map of keys and their owning expression (pair index)
        var owners = {};
        ...
        for(var itemIndex = 0; itemIndex < input.length; itemIndex++) {
            ...
            for(var pairIndex = 0; pairIndex < expr.lhs.length; pairIndex++) {
                ...
                // check that this key isn't associated with a different expression
                if(owners.hasOwnProperty(key)) {
                    if(owners[key] !== pairIndex) {
